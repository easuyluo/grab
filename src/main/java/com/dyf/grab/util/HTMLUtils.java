...
public abstract class HTMLUtils {
	 ...
	 * 
	 * @param url    url地址
	 * @param encode 编码 如果encode为空,则以GBK形式转换.
	 * @return 页面源代码
	 * @author Belen
	 * @throws HanyaException
	 */
	public static String getHtml2(String url, String encode) throws Exception {
		if (url == null)
		...
		try {
			...
			buf = null;
			result = new String(html.toString().trim().getBytes("ISO-8859-1"), encode).toLowerCase();
